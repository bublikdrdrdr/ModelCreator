...
public class RoadModel extends Model{
    ...
    public RoadModel() {
        ...
        Polygon[] buildPolygons = new Polygon[]{
            ...
            //start lone
            p(0, 24, 24, 0, 24, 5, dur, d(1), 0),
            p(5, 24, 24, 5, 24, 16, dur, d(1), 0),
            p(0, 2, 2, 0, 2, 24, dur, d(1), 0),
            p(24, 2, 2, 24, 2, 26, dur, d(1), 0),
            p(26, 2, 2, 26, 2, 27, dur, d(1), 0),
            p(27, 2, 2, 27, 2, 7, dur, d(1), 0),
            p(27, 7, 7, 27, 7, 5, dur, d(1), 0),
            p(16, 27, 27, 16, 27, 5, dur, d(1), 0),
            p(24, 26, 26, 24, 26, 16, dur, d(3), 1),
            p(16, 26, 26, 16, 26, 27, dur, d(3), 1),
            //end lone
        };
        ...
        Polygon[] destroyLonePolygons = new Polygon[10];
        j = 58;
        for (int i = 0; i < 10; i++){
